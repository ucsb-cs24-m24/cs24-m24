...
1. Convert Sorted Array to Binary Search Tree (easy): <https://leetcode.com/problems/convert-sorted-array-to-binary-search-tree/description/>
2. Find Mode in Binary Search Tree (easy): <https://leetcode.com/problems/find-mode-in-binary-search-tree/description/>
3. Convert BST to Greater Tree (medium): <https://leetcode.com/problems/convert-bst-to-greater-tree/description/>
